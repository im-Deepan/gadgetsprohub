  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 mt-4 font-sans">
      ...
      <div className="text-center space-y-4 mb-12">
        <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-amber-50 dark:bg-amber-950/20 text-amber-500 dark:text-amber-300 mb-2">
        ...
        <p className="text-xs font-mono text-amber-500 dark:text-amber-300 uppercase tracking-widest font-semibold">
      ...
      <div className="space-y-8 bg-white border border-slate-50 rounded-3xl p-6 md:p-10 dark:bg-slate-800 dark:border-slate-700 shadow-sm transition-all">
        ...
        <section className="space-y-3">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-200 leading-relaxed mt-1">
        ...
        <section className="space-y-3">
          <h2 className="text-sm font-bold uppercase tracking-wider text-slate-800 dark:text-white flex items-center gap-2">
            <FileWarning className="h-4 w-4 text-indigo-400" />
        ...
        <div className="pt-6 border-t border-slate-50 dark:border-slate-700 text-center text-[10px] text-slate-300">
