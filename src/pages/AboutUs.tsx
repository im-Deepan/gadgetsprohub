    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 mt-4">
      ...
      <div className="text-center space-y-4 mb-12">
        ...
        <p className="max-w-xl mx-auto text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
          Welcome to <span className="font-bold text-slate-700 dark:text-slate-300">gadgetsprohub</span>. We deliver honest, data-backed reviews and specifications for electronic gear, smart home assistants, lifestyle wear, and athletic devices.
        </p>
      </div>
      ...
      <div className="space-y-8 bg-white border border-slate-100 rounded-3xl p-6 md:p-10 dark:bg-slate-900 dark:border-slate-800 shadow-sm transition-all">
        ...
        <div className="pt-6 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-left">
            <h4 className="text-xs font-bold text-slate-900 dark:text-white font-sans">Have questions or want us to audit a product?</h4>
            <p className="text-[10px] text-slate-400 mt-0.5">We respond to specifications, feedback, and manufacturer reviews requests.</p>
          </div>
