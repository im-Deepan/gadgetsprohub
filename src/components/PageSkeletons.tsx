  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="flex items-center gap-2 mb-8 animate-pulse">
        <div className="h-4 w-12 bg-slate-100 dark:bg-slate-700 rounded"></div>
        <div className="h-3 w-3 bg-slate-100 dark:bg-slate-700 rounded-full"></div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-64 shrink-0 space-y-6">
          <div className="h-12 bg-slate-100 dark:bg-slate-700 rounded-2xl animate-pulse"></div>
          <div className="h-48 bg-slate-100 dark:bg-slate-700 rounded-2xl animate-pulse hidden lg:block"></div>
        </div>

        {/* Product Grid Area */}
        <div className="flex-grow space-y-8">
          <div className="flex items-center justify-between pb-4 border-b border-slate-50 dark:border-slate-700 animate-pulse">
            <div className="h-6 w-36 bg-slate-100 dark:bg-slate-700 rounded"></div>
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-4 mb-12 animate-pulse">
        <div className="h-6 w-32 bg-slate-100 dark:bg-slate-700 rounded-full mx-auto"></div>
        <div className="h-8 w-64 sm:w-96 bg-slate-100 dark:bg-slate-700 rounded mx-auto"></div>
        <div className="h-4 w-full max-w-xs bg-slate-100 dark:bg-slate-700 rounded mx-auto"></div>
        <div className="h-10 w-full max-w-md bg-slate-100 dark:bg-slate-700 rounded-full mx-auto mt-4"></div>
      </div>
