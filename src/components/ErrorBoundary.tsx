          ...
          <div className="w-full max-w-md bg-white dark:bg-slate-800 border border-slate-50 dark:border-slate-700 rounded-2xl p-8 shadow-sm">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full inline-flex items-center justify-center px-4 py-2.5 rounded-xl text-sm font-medium bg-indigo-500 hover:bg-indigo-600 text-white transition-all duration-300 cursor-pointer shadow-sm shadow-indigo-50 dark:shadow-none font-sans"
              >
              ...
              <div className="flex gap-2.5">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center px-4 py-2.5 rounded-xl text-xs font-semibold bg-slate-50 hover:bg-slate-100 dark:bg-slate-700 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-200 transition-colors duration-300 cursor-pointer"
                >
                  Go to Home
                </button>
                <button
